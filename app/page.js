    ...
    <div className=' m-10'>
      ...
      <div className='grid justify-items-center h-full  '>
        ...
        <div className=' m-5  justify-self-center'>
          ...
          <p className=' text-2x1 mt-5 text-slate-500 '>
            I give talks and write blog posts <br></br> about open source, coding, tutorials, etc. Occasionally, <br></br> I also do some coding live streams on YouTube.
          ...
          <p className=' text-2x1 mt-5 text-slate-500 '>
            Outside of programming, I enjoy doing photography and traveling.<br></br> Some of my photos can be found on Instagram.<br></br> Right now I live in Aburoad . If you are around, feel free to reach me out <br></br> we could have some coffee or work together.
          </p>
          ...
          <p className='mt-5 text-center text-gray-500' >Or Mail me at Namits41@gmail.com</p>
